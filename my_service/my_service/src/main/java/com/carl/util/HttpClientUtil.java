...
public class HttpClientUtil {
    ...
    public static void main(String[] args) {
    	...
    	String urls = "https://free-api.heweather.com/s6/weather/forecast?";
    	String parameters = "location=auto_ip&username=HE1803161415121438&t=" + seconds;
        String requestByget = requestByGet(urls+parameters, 1000 * 5);
